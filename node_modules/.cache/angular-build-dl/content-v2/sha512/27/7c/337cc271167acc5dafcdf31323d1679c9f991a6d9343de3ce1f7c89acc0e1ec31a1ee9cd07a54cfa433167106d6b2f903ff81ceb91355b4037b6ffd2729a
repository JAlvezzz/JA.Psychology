...
class GeneralService {
    ...
    // TEAM
    getTeamMembers() {
        return this.teamMembers.map(x => ({ id: x.id, nameIdentifier: x.nameIdentifier, fullName: x.fullName, role: x.role }));
    }
    getTeamDetails(nameIdentifier) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(this.teamMembers.find(x => x.nameIdentifier === nameIdentifier));
    }
    // SPECIALTIES
    getSpecialties() {
        return this.specialties.map(x => ({ id: x.id, nameIdentifier: x.nameIdentifier, title: x.title, description: x.description }));
    }
    getSpecialtiesDetails(nameIdentifier) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(this.specialties.find(x => x.nameIdentifier === nameIdentifier));
    }
}
...
//# sourceMappingURL=default~home-home-module~specialties-specialties-module~team-team-module-es2015.js.map